...
<body class="hold-transition skin-blue sidebar-mini <#if cookieMap?exists && "off" == cookieMap["wbtimerjob_adminlte_settings"].value >sidebar-collapse</#if>">
<div class="wrapper">
    <!-- header -->
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form" >
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="executorHandler" placeholder="请输入“任务名称”" maxlength="100" ></div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="firstname" class="col-sm-2 control-label">子任务ID<font color="black">*</font></label>
                    ...
                    <div class="form-group" >
                        ...
                        <label for="lastname" class="col-sm-2 control-label">路由策略<font color="red">*</font></label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group" style="display: none;" >
                        ...
                        <label   for="lastname" class="col-sm-2 control-label">执行参数<font color="black">*</font></label>
                    ...
                    <div class="form-group">
                        <label for="firstname" class="col-sm-2 control-label">负责人<font color="red">*</font></label>
...
package com.eshore.wbtimer.service.handler;

import com.eshore.wbtimer.common.log.WbtimerJobLogger;
import com.eshore.wbtimer.common.biz.model.ReturnT;
import com.eshore.wbtimer.common.handler.IJobHandler;

public class DemoGlueJobHandler extends IJobHandler {

	@Override
	public ReturnT<String> execute(String param) throws Exception {
		WbtimerJobLogger.log("Wbtimer-JOB, Hello World.");
...
print "wbtimer-job: hello python"
...
#!/usr/bin/env node
console.log("wbtimer-job: hello nodejs")
...
<script src="${request.contextPath}/static/plugins/cron/js/cronGen.min.js"></script>
</body>
</html>