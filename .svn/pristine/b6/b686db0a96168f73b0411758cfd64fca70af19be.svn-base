...
@TableName("WSBS_WSYSL")
public class WsbsWsyslBean extends DBTableParamBean implements Serializable {
    ...
    private String ywckdm;

    private String ckfwryzjhm;

    private String ckfwryzjxm;

    public WsbsWsyslBean(Long hjslbs, String sblsh, String sxbm, String bmmc, String blrgh, String blrxm, String cljgdm, String cljgms, String ysljtdd, String zzjgdm, String xzqhdm, String bjbzsm, String bz, String byzd, Date createTime, String dataSource, BigDecimal processinstid, String clrgh, String clrxm, String sbxmmc, String needsendmsg, String smscontent, String autostate, Date autotime, String ywckdm, String ckfwryzjhm, String ckfwryzjxm) {
        this.hjslbs = hjslbs;
        this.sblsh = sblsh;
        this.sxbm = sxbm;
        this.bmmc = bmmc;
        ...
        this.ywckdm = ywckdm;
        this.ckfwryzjhm = ckfwryzjhm;
        this.ckfwryzjxm = ckfwryzjxm;
    }

    public WsbsWsyslBean() {
        super();
    }
    ...
    public void setBlrgh(String blrgh) {
        this.blrgh = blrgh == null ? null : blrgh.trim();
    }
    ...
    public void setBlrxm(String blrxm) {
        this.blrxm = blrxm == null ? null : blrxm.trim();
    }
    ...
    public void setYsljtdd(String ysljtdd) {
        this.ysljtdd = ysljtdd == null ? null : ysljtdd.trim();
    }
    ...
    public void setBjbzsm(String bjbzsm) {
        this.bjbzsm = bjbzsm == null ? null : bjbzsm.trim();
    }
    ...
    public String getYwckdm() {
        return ywckdm;
    }

    public void setYwckdm(String ywckdm) {
        this.ywckdm = ywckdm == null ? null : ywckdm.trim();
    }

    public String getCkfwryzjhm() {
        return ckfwryzjhm;
    }

    public void setCkfwryzjhm(String ckfwryzjhm) {
        this.ckfwryzjhm = ckfwryzjhm == null ? null : ckfwryzjhm.trim();
    }

    public String getCkfwryzjxm() {
        return ckfwryzjxm;
    }

    public void setCkfwryzjxm(String ckfwryzjxm) {
        this.ckfwryzjxm = ckfwryzjxm == null ? null : ckfwryzjxm.trim();
    }
}