                ...
                "render": function ( data, type, row ) {
                    return function(){
                        ...
                        if ('NORMAL' == row.jobStatus) {
                            pause_resume = '<button class="btn btn-primary btn-xs job_operate" _type="job_pause" type="button">暂停任务</button>  ';
                        } else if ('PAUSED' == row.jobStatus){
                            pause_resume = '<button class="btn btn-primary btn-xs job_operate" _type="job_resume" type="button">恢复任务</button>  ';
                        }
                        // log url
                        ...
                        var html = '<p id="'+ row.id +'" >'+
                            '<button class="btn btn-primary btn-xs job_operate" _type="job_trigger" type="button">执行一次</button>  '+
                            pause_resume +
                            '<button class="btn btn-primary btn-xs" type="job_del" type="button" onclick="javascript:window.open(\'' + logUrl + '\')" >查看日志</button>  '+
                            '<br><button class="btn btn-warning btn-xs update" type="button">编辑任务</button>  '+
                            codeBtn +
                            '<button class="btn btn-danger btn-xs job_operate" _type="job_del" type="button">删除任务</button>  '+
                            '</p>';
...
function createCronSelect(divId) {
    /*$('#div'+divId).empty();
    var cronhtml='<input id='+divId+'   class="form-control" readonly>';
    $('#div'+divId).append(cronhtml);
    $('#'+divId).cronGen({
        direction : 'bottom',
        val:''
    });*/
