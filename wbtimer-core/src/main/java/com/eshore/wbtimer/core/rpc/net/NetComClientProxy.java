...
import com.eshore.wbtimer.core.rpc.net.jetty.client.JettyClient;
...
/**
 * 描述: 远程动态代理类（调用方法的时候请求）
 *
 * @author Yangjinming
 * @create 2018-01-10 19:07
 */
                ...
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        if (Object.class.getName().equals(method.getDeclaringClass().getName())) {
                            logger.error(">>>>>>>>>>> wbtimer-rpc proxy class-method not support [{}.{}]", method.getDeclaringClass().getName(), method.getName());
                            throw new RuntimeException("wbtimer-rpc proxy class-method not support");
                        }
                        ...
                        // valid response
                        if (response == null) {
                            logger.error(">>>>>>>>>>> wbtimer-rpc netty response not found.");
                            throw new Exception(">>>>>>>>>>> wbtimer-rpc netty response not found.");
                        }
                        if (response.isError()) {
